package com.emrecavdar.sqliteproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            database.execSQL("CREATE TABLE IF NOT EXİSTS musicians(id INTEGER PRIMARY KEY ,name VARCHAR,age INTEGER)");
                                                                //INT olarak yazmak id yi artırmıyor...
